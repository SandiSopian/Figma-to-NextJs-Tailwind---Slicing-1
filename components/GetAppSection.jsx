...
export default function GetAppSection() {
  return (
    <section className="flex flex-col-reverse sm:flex-row items-right sm:mt-20 md:mt-6">
      ...
      <div className="sm:w-7/12 rounded-lg bg-cover">
        <div>
          <ImgAsset image="/App.png" imageClassName="max-w-[100%] sm:max-w-[120%] lg:-ml-28 sm:-ml-8 mt-16 sm:mt-8 mb-6 sm:mb-20" />
        </div>
      </div>
    </section>
  );
